...
export const deviceApi = {
  ...
  get: (id: string) => apiClient.get(`/api/devices/${id}`),

  create: (device: DeviceCreate) => apiClient.post("/api/devices", device),
  ...
  wake: (id: string) => apiClient.post(`/api/devices/${id}/wake`),
};
