    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Group devices and agents together, then manage wake operations from a single place.
          </DialogDescription>
        </DialogHeader>
        <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
          <FieldGroup>
            <Field data-invalid={!!form.formState.errors.name || undefined}>
              ...
              <FieldContent>
                <Input {...form.register("name")} placeholder="Office workstations" />
              </FieldContent>
            ...
            <Field>
              ...
              <FieldContent>
                <Input {...form.register("tags")} placeholder="office, desktops, lab" />
              </FieldContent>
            ...
            <Field>
              ...
              <FieldContent>
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="start" className="max-h-64 w-96">
                    ...
                    {devices.map((device) => (
                      <DropdownMenuCheckboxItem
                        ...
                        onCheckedChange={() => toggleSelection("device_ids", device.id)}
                      >
              ...
              <FieldDescription>
                Devices remain editable on the dashboard after cluster assignment.
              </FieldDescription>
            </Field>
            ...
            <Field>
                  ...
                  <DropdownMenuContent align="start" className="max-h-64 w-96">
                    ...
                    {agents.map((agent) => (
                      <DropdownMenuCheckboxItem
                        ...
                        onCheckedChange={() => toggleSelection("agent_ids", agent.id)}
                      >
                        <span className="flex w-full items-center justify-between gap-3">
              ...
              <FieldDescription>
                Devices inside the cluster can then select one or more of these agents for wake requests.
              </FieldDescription>
            </Field>
          </FieldGroup>
          ...
          <DialogFooter>
            ...
            <Button type="submit">{cluster ? "Update" : "Create"} Cluster</Button>
          </DialogFooter>
        </form>
      </DialogContent>
    </Dialog>
