...
export const DeviceFormDialog = ({
  ...
  useEffect(() => {
    ...
    if (
      ...
      form.setValue("agent_ids", [availableAgents[0].id], {
        shouldDirty: true,
      });
    }
        ...
        <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
          <div className="-mx-4 no-scrollbar max-h-[80svh] overflow-y-auto px-4">
            <FieldGroup>
              ...
              <Field
                data-invalid={!!form.formState.errors.mac_address || undefined}
              >
              ...
              <Field
                data-invalid={!!form.formState.errors.ip_address || undefined}
              >
              ...
              <Field
                data-invalid={!!form.formState.errors.os_type || undefined}
              >
                ...
                <FieldContent>
                  <Select
                    ...
                    onValueChange={(value) =>
                      form.setValue(
                        "os_type",
                        value as "linux" | "windows" | "macos",
                      )
                    }
                  >
                    <SelectTrigger
                      aria-invalid={!!form.formState.errors.os_type}
                    >
                ...
                {form.formState.errors.os_type && (
                  <FieldError>
                    {form.formState.errors.os_type.message}
                  </FieldError>
                )}
              </Field>
              ...
              <Field>
                ...
                <FieldDescription>
                  All selected agents will receive the wake request for this
                  device.
                </FieldDescription>
              </Field>
            </FieldGroup>
